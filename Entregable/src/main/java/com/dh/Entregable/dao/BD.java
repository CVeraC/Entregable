...
public class BD {
    ...
    public static void createTable(){
        ...
        try {
            ...
            LOGGER.info("Estamos creando una tabla odontologos");
            statement.execute(DROP_CREATE_ODONTOLOGOS);

            LOGGER.info("Estamos importando un odontologo en la tabla odontologos");
    ...
    public static Connection getConnection() throws Exception {
        ...
        return DriverManager.getConnection( "jdbc:h2:./Backend","sa"," ");
